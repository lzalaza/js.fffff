    ...
    <section className="top-sellers">
      ...
      <footer>
        <div className="footer-columns">
          ...
          <br />
          <li><Link to="/shopping">Shopping info</Link></li>
          <br />
          ...
          <br />
          <li><Link to="/ADs">Advertising</Link></li>
          <br />
          ...
          <div className="getemail">
            ...
            <form className="grt">
              <input className="getem" type="email" placeholder="Enter email" />
              <button className="getema" type="submit">&rarr;</button>
            </form>
        ...
        <div className="payt">
          ...
          <p className="foot-bottom"> &copy;{new Date().getFullYear()}Privacy Policy , Terms & Conditions</p>
          <div className="payment-icons">
          <img src="https://s3-alpha-sig.figma.com/img/1c9d/d583/24bc8d20ec2fb9c01ac67e66ab576c6a?Expires=1736121600&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=KAYsEjdns9r0YePs9lKnAVR1j~B9eQMrUPRh2yI3ZnQNnYPZGc~P8hDNMOvQ7XHVkZEnPDm162WVVWX3Y3Jq2HPrgK2aDH-DS7vrd7C3WdFE6ugmQ8BSlD8wIX82xyjomOGisfBqZaRYGvT08D8N1R5ca83nmHIxusPEB8yuCdKdkhs0ePOEtqggR1NbKgqBns7kVYCgVlQRhfSY2lYrXEBIdZuOg4J-V4jV4za7GrSqOuFaHjxMwrDZO6Y2ER9COSTHSajI6dfAi0YXFBjoQHtYkNLFAd30dxjZb6PwwRl-fCQQd266StJqPi-JVGf7SpOT4gjxT1hzA2kppl8qbg__" alt="Visa" />
